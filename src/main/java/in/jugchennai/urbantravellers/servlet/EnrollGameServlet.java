 ...
 */
package in.jugchennai.urbantravellers.servlet;
 ...
 */
@WebServlet(name = "EnrollGameServlet", urlPatterns = {"/enrollgame"})
public class EnrollGameServlet extends HttpServlet {

    private static GameCache cache = GameCache.getInstance();
    private static GameBoard gameBoard = cache.getBoard();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (playerName) {
            case "arivu":
                player = new Player("arivu");
                break;
            case "raj":
                player = new Player("raj");
                break;
            case "shiv":
        ...
        if(player!=null) {
            try {
                ...
                Logger.getLogger(EnrollGameServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
